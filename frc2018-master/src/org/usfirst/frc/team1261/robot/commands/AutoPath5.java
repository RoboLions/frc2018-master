...
public class AutoPath5 extends CommandGroup {
    ...
    public AutoPath5(boolean execute) {
    	...
    	addSequential(new AutoMove(1.5, 0, 3, 0.5)); //move forward - 1.5
    	...
    	addSequential(new AutoMove(1.2, 0, 3, 0.5)); //move forward until parallel with switch deposit area - 1.4
