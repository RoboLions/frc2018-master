...
public class AutoPath5 extends CommandGroup {
    ...
    public AutoPath5(boolean execute) {
    	...
    	addSequential(new AutoMove(.8, 0, 5)); //move forward - 1.5
    	...
    	addSequential(new AutoMove(0.5, 0, 5)); //move forward until parallel with switch deposit area - 1.4
    	...
    	addSequential(new AutoMove(1.1, 0, 1)); //go to switch - 1.1
