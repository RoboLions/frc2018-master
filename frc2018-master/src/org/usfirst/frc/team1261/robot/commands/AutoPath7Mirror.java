...
public class AutoPath7Mirror extends CommandGroup {
    ...
    public AutoPath7Mirror(boolean execute) {
    	...
    	addSequential(new AutoMove(3, 0, 3.5, 1.0)); //move forward
        ...
        addSequential(new AutoMove(2.9, 0, 3, 1.0)); //move to edge of switch
        ...
        addSequential(new AutoMove(1, 0, 2, 1.0)); //go to switch
