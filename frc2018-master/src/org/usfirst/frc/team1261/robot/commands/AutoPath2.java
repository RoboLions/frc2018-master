 ...
 *
 */
public class AutoPath2 extends CommandGroup {

    public AutoPath2(boolean execute) {
    	if(execute == true) {
    	System.out.println("***AUTO PATH 2***");
    	addSequential(new AutoMove(5.2, 0.0, 6, 1.0)); //move forward
    	...
    	addSequential(new AutoMove(1.6, 0, 3, 1.0)); //move forward to postition parellel with switch deposit
