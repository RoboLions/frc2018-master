...
public class AutoPath5Mirror extends CommandGroup {
    ...
    public AutoPath5Mirror(boolean execute) {
    	...
    	addSequential(new AutoMove(.75, 0, 5)); //move forward - 1.5
    	...
    	addSequential(new AutoMove(0.5, 0, 5)); //move forward until parallel with switch deposit area - 1.2
    	...
    	addSequential(new AutoMove(1, 0, 1)); //go to switch - 1.1
