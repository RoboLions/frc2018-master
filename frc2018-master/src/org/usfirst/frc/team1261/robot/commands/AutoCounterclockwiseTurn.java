...
public class AutoCounterclockwiseTurn extends Command {
    ...
    protected boolean isFinished() {
        //return (Robot.driveTrain.distanceTravelledinMeters() > POS_CMD);
    	return isTimedOut();
    }
