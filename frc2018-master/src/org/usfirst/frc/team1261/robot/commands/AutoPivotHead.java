...
public class AutoPivotHead extends Command {
		
		public static final double POWER = .4;
		public static final double YAW_GAIN = 8.2;
		...
		double target_yaw = 0.0; //HEAD_CMD; is not final because if it was we cannot change it.
