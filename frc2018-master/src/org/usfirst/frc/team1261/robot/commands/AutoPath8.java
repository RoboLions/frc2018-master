 ...
 *
 */
public class AutoPath8 extends CommandGroup {

    public AutoPath8(boolean execute) {
    	if(execute == true) {
    	System.out.println("***AUTO PATH 8***");
        ...
        addSequential(new AutoMove(1.5, 0, 3, 1.0)); //move to parallel with switch deposit zone
        ...
        addSequential(new AutoMove(.6, 0, 1, 1.0)); //go to switch
